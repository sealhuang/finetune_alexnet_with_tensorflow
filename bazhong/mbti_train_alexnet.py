...
from datasource import source_mbti_data
from imgdatagenerator import MBTIDataGenerator as ImageDataGenerator
...
def model_train(train_imgs, train_labels, val_imgs, val_labels):
    ...
    filewriter_path = os.path.join(current_dir, 'log','mbti_alex_cls_tensorboard')
    checkpoint_path = os.path.join(current_dir, 'log','mbti_alex_cls_checkpoints')
    ...
    # Initialize model
    model = AlexNetBN(x, keep_prob, num_classes, is_train)
...
if __name__ == '__main__':
    ...
    data_file = os.path.join(current_dir, 'data', 'anony_mbti_factors.csv')
    img_dir = os.path.join(current_dir, 'data', 'bnu_faces')
    train_imgs, train_labels, val_imgs, val_labels = source_mbti_data(data_file,
                                                                      img_dir, 
                                                                      rand_val=False,
                                                                      gender=None)
