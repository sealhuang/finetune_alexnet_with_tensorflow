...
if __name__=='__main__':
    ...
    # load stimuli info
    stimuli_group_file = os.path.join(feat_dir, 'stimuli_group.csv')
    ...
    for emo in emo_type:
        for g in gender:
            ...
            for i in range(len(info)):
                if info[i][1]==emo and info[i][2]==g:
                    l.append(int(i))
            indexs['%s_%s'%(emo, g)] = l
